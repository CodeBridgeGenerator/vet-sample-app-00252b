...
import SingleCatPage from "../components/CatPage/SingleCatPage";
import CatProjectLayoutPage from "../components/CatPage/CatProjectLayoutPage";
import SingleDogPage from "../components/DogPage/SingleDogPage";
import DogProjectLayoutPage from "../components/DogPage/DogProjectLayoutPage";
// ~cb-add-import~
...
<Route path="/cat/:singleCatId" exact element={<SingleCatPage />} />
<Route path="/cat" exact element={<CatProjectLayoutPage />} />
<Route path="/dog/:singleDogId" exact element={<SingleDogPage />} />
<Route path="/dog" exact element={<DogProjectLayoutPage />} />
